...
print("Found %d lines" % len(found_lines))
for i, line in found_lines[:5]:
...
print("Found %d lines with provinces" % len(found_provinces))
for p, line in found_provinces[:5]:
    print("Province %s: %s" % (p, line))
