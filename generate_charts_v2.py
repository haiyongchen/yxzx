...
plt.tight_layout()
plt.savefig(f'{chart_dir}\\chart1_cost_trend.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'{chart_dir}\\chart2_cost_rate_distribution.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'{chart_dir}\\chart3_problem_distribution.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'{chart_dir}\\chart4_province_cost_comparison.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'{chart_dir}\\chart5_province_cost_rate.png', dpi=150, bbox_inches='tight')
plt.close()
