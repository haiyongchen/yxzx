...
subtitle = doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')

doc.add_heading('4.2 26年度新开设专区跟进计划', 2)
doc.add_paragraph('责任人：XXX    完成时间：2026年6月30日')
doc.add_paragraph('跟进措施：')
doc.add_paragraph('重点关注' + str(len(df_2026)) + '个新开设专区，月度跟踪收益情况', style='List Bullet')
doc.add_paragraph('目标Q2实现50%专区首笔收益', style='List Bullet')
doc.add_paragraph('对零收益专区进行专项分析，制定上量方案', style='List Bullet')

# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('（合同编号C开头或暂无 - 专区名称维度分析）')
subtitle.alignment = WD_ALIGN_PARAGRAPH.CENTER
subtitle.runs[0].font.size = Pt(14)
subtitle.runs[0].font.color.rgb = RGBColor(102, 102, 102)
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('中原区、华北区运营分析报告').alignment = WD_ALIGN_PARAGRAPH.CENTER
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('报告日期：2026年3月31日').alignment = WD_ALIGN_PARAGRAPH.CENTER
doc.add_page_break()
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('截至2026年3月31日，新点e交易（中原、华北区）合同编号以C开头或暂无的专区共运营' + str(len(df)) + '个，其中原有专区' + str(len(df_old)) + '个，26年度新开设' + str(len(df_2026)) + '个。')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph(str(high_cost) + '个专区成本超过32,000元基线', style='List Bullet')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('部分专区零收益，成本无法回收', style='List Bullet')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('26年度新开设' + str(len(df_2026)) + '个专区目前收益均为0，需关注后续上量', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('对成本超标专区进行成本复盘', style='List Bullet')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('对零收益专区进行下线评估', style='List Bullet')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('对26年度新开设专区进行月度跟踪', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('【数据说明】专区名称取自各表格C列（原专区名称字段）')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('责任人：XXX    完成时间：2026年4月30日')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('问题专区：成本TOP10中的超标专区')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
...
# 保存
doc.save('D:\work\运营中心\yxzx\新点e交易相关材料\日常数据运维工具\temp\e交易专区收益成本统计报告_C合同_专区名称维度_完整版.docx')
print('报告生成成功')agraph('分析成本构成：人力成本、系统对接成本、运维成本占比', style='List Bullet')
doc.add_paragraph('识别超支原因：需求变更、实施周期延长、技术难点', style='List Bullet')
doc.add_paragraph('制定控制措施：严格需求变更管理、优化实施流程', style='List Bullet')
