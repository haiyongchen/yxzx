...
// 数据统计结果（基于实际数据分析）
const stats = {
  indicator1: 12,  // 接入超过1年，总收益为0
  indicator2: 49,  // 接入超过1年，0<总收益<10w
  indicator3: 39,  // 接入超过1年，0<总收益<5w
  indicator4: 37,  // 25年前接入，0<25年收益<10w
  indicator5: 33,  // 25年前接入，0<25年收益<5w
  indicator6: 34,  // 26年产生收益
  indicator7: 20,  // 25年有收益，26年无
};
...
function createCell(text, options = {}) {
  ...
  return new TableCell({
    ...
    children: [
      new Paragraph({
        alignment: alignment,
        children: [new TextRun({ text: text, bold: bold, size: 21 })],
      }),
    ],
  });
}
  ...
  sections: [
    {
      ...
      children: [
        ...
        new Paragraph({
          ...
          children: [
            new TextRun({
              text: "数据统计范围涵盖中原、华北等区域共114个专区，重点分析确认接入时间、25年总收益、26年总收益、总成本等关键指标。通过建立风险分级体系（红色-重点关注、橙色-需改进、黄色-观察、灰色-流失风险）。",
              size: 24,
            }),
          ],
        }),
          ...
          rows: [
            ...
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator1), { width: 1200 }),
            ...
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator2), { width: 1200 }),
                createCell("红色", { width: 1500 }),
                createCell("重点关注", { width: 2000 }),
              ],
            }),
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator3), { width: 1200 }),
                createCell("红色", { width: 1500 }),
                createCell("重点关注", { width: 2000 }),
              ],
            }),
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator4), { width: 1200 }),
            ...
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator5), { width: 1200 }),
                createCell("橙色", { width: 1500 }),
                createCell("需改进", { width: 2000 }),
              ],
            }),
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator6), { width: 1200 }),
            ...
            new TableRow({
              children: [
                ...
                createCell(String(stats.indicator7), { width: 1200 }),
...
// 保存文档
const outputPath = "D:\\work\\运营中心\\yxzx\\新点e交易相关材料\\日常数据运维工具\\e交易数据分析处理文件\\e交易专区收益成本统计报告_新.docx";
